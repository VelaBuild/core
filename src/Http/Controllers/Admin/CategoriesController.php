...
use VelaBuild\Core\Http\Requests\MassDestroyCategoryRequest;
use VelaBuild\Core\Http\Requests\StoreCategoryRequest;
use VelaBuild\Core\Http\Requests\UpdateCategoryRequest;
...
class CategoriesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $table->editColumn('order_by', function ($row) {
        ...
        return view('vela::admin.categories.index');
    }
    ...
    public function create()
    {
        ...
        return view('vela::admin.categories.create');
    }
    ...
    public function store(StoreCategoryRequest $request)
    {
        ...
        return redirect()->route('vela.admin.categories.index');
    }
    ...
    public function edit(Category $category)
    {
        ...
        return view('vela::admin.categories.edit', compact('category'));
    }
    ...
    public function show(Category $category)
    {
        ...
        return view('vela::admin.categories.show', compact('category'));
    }
