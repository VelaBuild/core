...
return [
    ...
    'login_unavailable_title'        => 'Login Unavailable',
    'login_unavailable_body'         => 'Login is not enabled, please contact your site administrator.',
    'login_disabled_body'            => 'Login is not enabled, please contact your site administrator.',
    ...
    'discard_block_changes'          => 'Discard your changes to this block?',
    'just_now'                       => 'just now',
    ...
    'categories_grid_empty_title'    => 'No topics yet',
    'categories_grid_empty_message'  => 'Topics help organize articles. Add a few to see them here.',
    'categories_grid_empty_cta'      => 'Create your first topic',
    'testimonials_empty_title'       => 'No testimonials yet',
    'testimonials_empty_message'     => 'Add testimonials in the block editor to show customer quotes here.',
    'reviews_empty_title'            => 'No reviews yet',
    'review_out_of_five'             => 'out of 5',
    'review_count'                   => 'based on :count review|based on :count reviews',
    'review_rating_label'            => ':rating out of 5 stars',
    'review_manage_cta'              => 'Manage reviews',
    'review_strip_label'             => 'Reviews',
    'reviews_empty_message'          => 'Reviews from your visitors will appear here.',
    'icon_box_empty_title'           => 'No items yet',
    'icon_box_empty_message'         => 'Add items in the block editor to showcase features or steps.',
    'gallery_empty_title'            => 'No images yet',
    'gallery_empty_message'          => 'Upload images in the block editor to display them here.',
    'carousel_empty_title'           => 'No slides yet',
    'carousel_empty_message'         => 'Add slides in the block editor to populate the carousel.',
    ...
    'block_type_carousel'            => 'Carousel',
    'block_type_gallery'             => 'Gallery',
    'block_type_testimonials'        => 'Testimonials',
    'block_type_icon_box'            => 'Icon Box',
    'block_type_categories_grid'     => 'Categories Grid',
    'block_type_posts_grid'          => 'Posts Grid',
    'block_type_app_download'        => 'App Download',
    'block_type_code'                => 'Code Snippet',
    'code_copy'                      => 'Copy',
    'health_mcp_missing'             => 'A package this version of Vela needs is not installed',
    'health_mcp_missing_body'        => 'The website editing gateway (laravel/mcp) is missing, so it is switched off. Everything else works as usual. Install it with:',
    'health_migrations_pending'      => 'The database is :count update|The database is :count updates behind',
    'health_migrations_pending_body' => 'Vela was updated but its database changes have not been run yet, so parts of the admin may fail. Waiting: :names. Run:',
    'code_copied'                    => 'Copied',
    'code_copy_failed'               => 'Copy failed',
    'code_show_all'                  => 'Show all :lines lines',
    'code_show_less'                 => 'Show less',
    'block_type_pricing_tiers'       => 'Pricing Tiers',
    'pricing_tiers_empty_title'      => 'No pricing tiers yet',
    'pricing_tiers_empty_message'    => 'Add tiers in the block editor to display your pricing plans.',
    'slides_count'                   => '{1} slide|[2,*] slides',
    'show_post_count_label'          => 'with post count',
    'columns'                        => 'columns',
    'empty_block'                    => 'Empty block',
    'install_homepage'               => 'Install Homepage',
    'theme_missing_title'              => 'The theme ":theme" is no longer installed.',
    'theme_missing_body'               => 'The site is being drawn with the :theme theme instead. Choose a theme below to settle on one — until you do, this screen has no colour options to offer, because they come from the theme.',
    'theme_missing_body_no_fallback'   => 'Choose a theme below. Until you do, this screen has no colour options to offer, because they come from the theme.',
