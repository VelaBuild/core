...
return [
    ...
    'login_unavailable_body'         => 'This site has not finished installing yet, so the login page is not available. Please run the installer or complete the database setup before signing in.',
    'login_disabled_body'            => 'Login is currently disabled because the database is not available. Please complete installation before attempting to sign in.',
