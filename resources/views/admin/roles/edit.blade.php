...
<div class="card">
    <div class="card-header">
        {{ trans('vela::global.edit') }} {{ trans('vela::cruds.role.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("vela.admin.roles.update", [$role->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                @endif
                <span class="help-block">{{ trans('vela::cruds.role.fields.title_helper') }}</span>
            </div>
            <div class="form-group">
                ...
                @endif
                <span class="help-block">{{ trans('vela::cruds.role.fields.permissions_helper') }}</span>
            </div>
            <div class="form-group">
