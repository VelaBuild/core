...
<div class="card">
    <div class="card-header">
        {{ trans('vela::global.create') }} {{ trans('vela::cruds.translation.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("vela.admin.translations.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="lang_code">{{ trans('vela::cruds.translation.fields.lang_code') }}</label>
                <input class="form-control {{ $errors->has('lang_code') ? 'is-invalid' : '' }}" type="text" name="lang_code" id="lang_code" value="{{ old('lang_code', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('model_type') ? 'is-invalid' : '' }}" type="text" name="model_type" id="model_type" value="{{ old('model_type', '') }}" required>
