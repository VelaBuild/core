                        ...
                        <div class="collapse" id="advanced-settings">
                            <div class="section-body">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control vela-code-input" name="custom_css" id="custom_css" rows="4" spellcheck="false" data-code-mode="css">{{ old('custom_css', '') }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label>{{ trans('vela::global.custom_js') }}</label>
                                    <textarea class="form-control vela-code-input" name="custom_js" id="custom_js" rows="4" spellcheck="false" data-code-mode="js">{{ old('custom_js', '') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
