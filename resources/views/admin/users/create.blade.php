...
<div class="card">
    <div class="card-header">
        {{ trans('vela::global.create') }} {{ trans('vela::cruds.user.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("vela.admin.users.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('last_login_at') ? 'is-invalid' : '' }}" type="text" name="last_login_at" id="last_login_at" value="{{ old('last_login_at') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('last_ip') ? 'is-invalid' : '' }}" type="text" name="last_ip" id="last_ip" value="{{ old('last_ip', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('useragent') ? 'is-invalid' : '' }}" type="text" name="useragent" id="useragent" value="{{ old('useragent', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('subscribe_newsletter') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="subscribe_newsletter" id="subscribe_newsletter" value="1" {{ old('subscribe_newsletter', 0) == 1 ? 'checked' : '' }}>
