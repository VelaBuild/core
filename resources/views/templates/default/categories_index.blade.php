...
<section class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="topics-grid">
            ...
            <a href="{{ route('vela.public.categories.show', Str::slug($category->name)) }}" class="topic-card">
                <div class="topic-image-container">
                    @if($category->image)
                    {!! vela_image($category->image->url, $category->name, [200, 400, 800], 'crop', ['class' => 'topic-image']) !!}
                    @else
        ...
        <div class="text-center py-16">
            ...
            <h2 class="text-xl font-semibold text-gray-900 mb-2">{{ __('vela::public.no_categories_available') }}</h2>
