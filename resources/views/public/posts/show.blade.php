    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
                <article class="prose prose-lg max-w-none">
                    ...
                    @if($post->main_image)
                    <div class="mb-8">
                        <img src="{{ $post->main_image->url }}" alt="{{ $post->title }}" class="w-full h-64 md:h-96 object-cover rounded-xl shadow-lg">
                    </div>
                    @endif
                    ...
                    <div class="mt-12">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div class="aspect-w-16 aspect-h-12">
                                <img src="{{ $image->url }}" alt="{{ $post->title }}" class="w-full h-48 object-cover rounded-lg shadow-lg">
                            </div>
                            @endforeach
                        </div>
                    </div>
        ...
        <div class="articles-grid">
            ...
            <article class="article-card">
                ...
                @if($relatedPost->main_image)
                        <img src="{{ $relatedPost->main_image->url }}" alt="{{ $relatedPost->translated_title }}" class="article-image">
                @else
